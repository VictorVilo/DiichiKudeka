package com.planner.diichi.notes;
...
import com.planner.diichi.view.home.HomeActivity;
...
public class MainActivity2 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void showFirstStartUpDialog() {
        new MaterialAlertDialogBuilder(this).setTitle(R.string.accessibility_settings).setMessage(R.string.accessibility_prompt).setPositiveButton(R.string.Yes, (dialogInterface, i) -> startActivity(new Intent(MainActivity2.this, SettingsActivity.class))).setNegativeButton(R.string.No, (dialogInterface, i) -> dialogInterface.dismiss()).create().show();
        SharedPreferences prefs = getSharedPreferences("prefs", MODE_PRIVATE);
